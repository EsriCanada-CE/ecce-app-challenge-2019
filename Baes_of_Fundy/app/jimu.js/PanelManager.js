...
function (declare, lang, array, html, baseFx, Deferred, all, on, topic, when,
  ...
  clazz = declare(null, {
    ...
    showPanel: function(config){
      ...
      var visibility=pid.includes("Filter");
      var layerUrl= "https://services9.arcgis.com/vFYngfYgyeXmwhNK/arcgis/rest/services/HRMParkRecreation/FeatureServer/0", id="HRMParkRecreation_9626";
